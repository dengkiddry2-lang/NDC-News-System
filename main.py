...
<body>
    ...
    <script>
        ...
        function esc(s) {{
            return String(s || '').replaceAll('&', '&amp;').replaceAll('<', '&lt;').replaceAll(/>/g, '&gt;').replaceAll('"', '&quot;');
        }}
